...
function activateModal(id, price) {
    ...
    case "Alien17":
        ...
        modalimg.src = "images/alienware17.png";
        break;
    case "MSI5":
    ...
    case "PredX":
        ...
        modalimg.src = "images/PredatorX.png";
        break;
    }
...
function displayInCart(id, price) {
    ...
    case "Alien17":
        ...
        $("#productentabel").find("tbody").append(
            "<tr>" +
            "<td><img src=\"images/alienware17.png\" alt=\"Alienware 17\">" +
            "<br>Alienware 17" +
    ...
    case "MSI5":
        ...
        $("#productentabel").find("tbody").append(
            "<tr>" +
            "<td><img src=\"images/msi.png\" alt=\"MSI 5\">" +
            "<br>MSI Hunter 5" +
    ...
    case "PredX":
        ...
        $("#productentabel").find("tbody").append(
            "<tr>" +
            "<td><img src=\"images/PredatorX.png\" alt=\"PredatorX\">" +
            "<br>Predator X" +
